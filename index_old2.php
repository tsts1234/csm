...
<div class="top_box_wrap">
	...
	<div class="top_box top_box_color_5">
		<a href="/bbs/write.php?bo_table=order"><img src="<?php echo G5_THEME_URL?>/img/sns/sns_05.jpg"></a>
	</div>

	<div class="top_box top_box_color_2">
		<a href="#" target="_blank"><img src="<?php echo G5_THEME_URL?>/img/sns/sns_02.jpg"></a>
	</div>

	<div class="top_box top_box_color_3"><a href="https://m.blog.naver.com/PostList.nhn?blogId=chaga8"><img src="<?php echo G5_THEME_URL?>/img/sns/sns_01.jpg"></a></div>
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide sli1">
					...
					<div class="c content">
						...
						<div class="head" data-ani-name="fadeInUp">KCC 창호 전문 시공점</div>
				...
				<div class="swiper-slide sli2">
					...
					<div class="c content ">
						...
						<div class="head " data-ani-name="fadeInUp">노메이커브랜드 취급</div>
