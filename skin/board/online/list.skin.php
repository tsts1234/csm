			...
			<div id="bo_list" style="width:<?php echo $width; ?>">
					...
					<div class="tbl_head01 tbl_wrap">
							...
							<tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
									...
									<td class="td_name sv_use"><?php echo $list[$i]['wr_7'] ?> → <?php echo $list[$i]['wr_8'] ?></td>
									<td class="td_name sv_use"><?php echo $list[$i]['wr_10'] ?></td>
									<td class="td_name sv_use"><?php echo $list[$i]['wr_9'] ?></td>
