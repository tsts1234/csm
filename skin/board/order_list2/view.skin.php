	...
	<div class="row">
		<div class="col-lg-12 mb-12">
			...
			<article id="bo_v" style="width:<?php echo $width; ?>">
				...
				<span class="견적상황">견적상황&nbsp;&nbsp;&nbsp;</span><strong>
				 <?php if ($view['wr_10']=="견적완료") { ?><div style="padding:0px 0 0 0;width:100px;height:25px; line-height:25px;background:#FF3061;color:#fff;font-weight:bold;text-align:center; font-size:15px;">견적완료</div> 
				 <?php }elseif($view['wr_10']=="견적중"){ ?><div style="padding:0px 0 0 0;width:100px;height:25px; line-height:25px;background:#5AD103;color:#fff;font-weight:bold;text-align:center; font-size:15px;">견적중</div>
				 <?php }elseif($view['wr_10']=="견적접수"){ ?><div style="padding:0px 0px 0 0;width:100px;height:25px; line-height:25px;background:#878ED3;color:#fff;font-weight:bold;text-align:center; font-size:15px;">견적접수</div>
				 <?php } ?>
				 </strong>
				 ...
				 <section id="bo_v_info">
					<h2>페이지 정보</h2>
					<!--<span class="sound_only">업체명</span> <strong>업체명:<?php echo $view['wr_1'] ?></strong>
					<span class="sound_only">이메일</span><strong>이메일:<?php echo $view['wr_email'] ?></strong>
					-->

					<table class="view_skin_wrap">
						<tr>
							<td><span class="sound_only">고객명</span><strong>고객명</strong></td>
							<td><?php echo $view['wr_name'] ?></td>
						</tr>
						<tr>
							<td><span class="sound_only">연락처</span><strong>연락처</strong></td>
							<td><?php echo $view['wr_1'] ?></td>
						</tr>
						<tr>
							<td><span class="sound_only">현장명</span><strong>현장명</strong></td>
							<td><?php echo $view['wr_2'] ?></td>
						</tr>
						<tr>
							<td><span class="sound_only">평수 및 층수</span><strong>평수 및 층수</strong></td>
							<td><?php echo $view['wr_3'] ?></td>
						</tr>
						<tr>
							<td><span class="sound_only">제목</span><strong>제목</strong></td>
							<td><?php echo $view['wr_subject'] ?></td>
						</tr>
					</table>

					<div class="view_skin_bottom_wrap">
						<span class="sound_only">조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i>조회 : <?php echo number_format($view['wr_hit']) ?>회</strong>
						<strong class="if_date"><span class="sound_only">요청일 : </span><i class="fa fa-clock-o" aria-hidden="true"></i>요청일 : <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
					</div>
				</section>
