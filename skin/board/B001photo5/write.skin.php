...
<?php include_once(G5_THEME_PATH.'/sub/sub5_top_bg.php');?>
		...
		<div class="col-lg-12 mb-12">
			...
			<section id="bo_w">
				...
				<div class="bo_w_link write_div">
					...
					<input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input full_input" size="50" placeholder="링크 #<?php echo $i ?>">
				</div>
				<?php } ?>
