...
<?php
include_once(G5_THEME_PATH.'/sub_top_04.php');
?>

<div id="ajax-a">
	<div class="ajax-b">
			<div class="container sub_wrap" style="margin-top:3%;">
				<!--
				<div class="row">
							...
							<div class="portfolio__grid hover--one three--columns">
								...
								?>
									...
									<div class="item">
										...
										<div style="color:#333; float:left; margin-top:10px;" class="txt">
											<a href="<?php echo $list[$i]['href'] ?>" style="font-size:15px; color:#000;">
...
<script type="text/javascript" defer src="<?php echo $board_skin_url ?>/imagesloaded.pkgd.min.js"></script>