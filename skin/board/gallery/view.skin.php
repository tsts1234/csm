...
<!------ 상단 ------>
<div id="sub3_top_wrap">

	<div class="sub_top_notice">
		<p class="sub_top_title">처음부터 끝가지 믿고<br>맡길수 있는 이사 서비스</p>
		<p class="sub_top_text">
			합리적인 가격으로 고객만족 100% 실현을 위해 노력합니다.
		</p>
	</div>
	<!--
	<div class="sub_bottom_wrap">
		<div class="sub_bottom">
			<div class="sub_bottom_click"><a href="<?php echo G5_URL?>/bbs/board.php?bo_table=11">인사말</a></div>
			<div class="sub_bottom_2"><a href="<?php echo G5_URL?>/bbs/board.php?bo_table=12">오시는길</a></div>
		</div>
	</div>
	-->
</div>
	...
	<div class="row">
		<div class="col-lg-12 mb-12">
			<div class="sub_01_01_title">
				<span class="sub_01_01_title_left"><?php echo $E_bo['bo_subject']?></span>
				<span class="sub_01_01_title_right">홈 ＞ 현장사진</span>
			</div>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">댓글</span><strong><a href="#bo_vc"> <?php echo number_format($view['wr_comment']) ?>건</a></strong>
