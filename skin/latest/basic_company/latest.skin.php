	  ...
	  <div class="col-md-4 margin-bottom-30">
		<div class="card <?php echo $cr[$i];?>">
		  <div class="card-body">
			...
			<h5 class="card-title ko1" style="margin-bottom:5%;">
			<?php
				if ($list[$i]['is_notice'])
			...
			<p class="card-text ko1 f15" style="margin-bottom:10px;height:80px;">
				<?php echo cut_str(strip_tags($list[$i]['wr_content']),'68','..')?>
				<?php
