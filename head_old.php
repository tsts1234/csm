...
<nav id="top_w_l" class="menu_button navbar fixed-top navbar-expand-lg navbar-white ">
	<div class="container">
		...
		<!-- 로고 --->
		<a class="navbar-brand" href="<?php echo G5_URL?>" class="logo"><img src="<?php echo G5_URL?>/theme/ety_theme_company_v1.2/img/si/logo1.png"></a>
		<!-- //로고 --->

		<div class="">
			<a href="tel:1899-9438" class="mobile_tel"><img src="<?php echo G5_URL?>/theme/ety_theme_company_v1.2/img/tel.png"></a>
