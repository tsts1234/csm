			...
			<div class="nav-wrapper d-flex">
				...
				<ul class="nav nav-pills d-none d-md-flex" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation">
						<a class="nav-link active" id="a1-tab" data-toggle="pill" href="#a1" role="tab" aria-controls="a1" aria-selected="true">NOMAKER 1</a>
					</li>
					<li class="nav-item" role="presentation">
						<a class="nav-link" id="a1-tab" data-toggle="pill" href="#a2" role="tab" aria-controls="a2" aria-selected="false">NOMAKER 2</a>
					</li>
					<li class="nav-item" role="presentation">
						<a class="nav-link" id="a1-tab" data-toggle="pill" href="#a3" role="tab" aria-controls="a3" aria-selected="false">NOMAKER 3</a>
					</li>
					<li class="nav-item" role="presentation">
						<a class="nav-link" id="a1-tab" data-toggle="pill" href="#a4" role="tab" aria-controls="a4" aria-selected="false">NOMAKER 4</a>
					</li>
					<li class="nav-item" role="presentation">
